...
import cv2
import numpy as np
from license_locate_step_1 import license_locate
window_h = 20
window_w = 180
...
if __name__ == '__main__':
    ...
    for i in range(8, 97):
        begin = time.time()
        filename = 'D:/Car_Identify/picture_for_train/'
        ...
        cv2.imwrite('D:/Car_Identify/picture_for_tilt/'+str(i)+'.jpg',image_need)
